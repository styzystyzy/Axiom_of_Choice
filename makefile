...
makefile.conf: 
	coq_makefile -o makefile Axiomatic_Set_Theory.v Basic_Definitions.v Finite_Character.v Hausdorff_Maximal_Principle.v Logic_Property.v Maximal_Principle.v Tukey_Lemma.v Wellordering_Theorem.v WO_Proof_AC.v Zermelo_Postulate.v Zermelo_Proof_AC.v Zorn_Lemma.v
